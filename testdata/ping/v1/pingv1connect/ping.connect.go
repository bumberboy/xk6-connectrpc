...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/bumberboy/xk6-connectrpc/testdata/ping/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	PingServiceName = "k6.connectrpc.ping.v1.PingService"
)
...
const (
	...
	PingServicePingProcedure = "/k6.connectrpc.ping.v1.PingService/Ping"
	// PingServiceFailProcedure is the fully-qualified name of the PingService's Fail RPC.
	PingServiceFailProcedure = "/k6.connectrpc.ping.v1.PingService/Fail"
	// PingServiceSumProcedure is the fully-qualified name of the PingService's Sum RPC.
	PingServiceSumProcedure = "/k6.connectrpc.ping.v1.PingService/Sum"
	// PingServiceCountUpProcedure is the fully-qualified name of the PingService's CountUp RPC.
	PingServiceCountUpProcedure = "/k6.connectrpc.ping.v1.PingService/CountUp"
	// PingServiceCumSumProcedure is the fully-qualified name of the PingService's CumSum RPC.
	PingServiceCumSumProcedure = "/k6.connectrpc.ping.v1.PingService/CumSum"
)

// PingServiceClient is a client for the k6.connectrpc.ping.v1.PingService service.
...
// NewPingServiceClient constructs a client for the k6.connectrpc.ping.v1.PingService service. By
...
// Ping calls k6.connectrpc.ping.v1.PingService.Ping.
...
// Fail calls k6.connectrpc.ping.v1.PingService.Fail.
...
// Sum calls k6.connectrpc.ping.v1.PingService.Sum.
...
// CountUp calls k6.connectrpc.ping.v1.PingService.CountUp.
...
// CumSum calls k6.connectrpc.ping.v1.PingService.CumSum.
...
// PingServiceHandler is an implementation of the k6.connectrpc.ping.v1.PingService service.
...
func NewPingServiceHandler(svc PingServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/k6.connectrpc.ping.v1.PingService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedPingServiceHandler) Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PingResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("k6.connectrpc.ping.v1.PingService.Ping is not implemented"))
}
...
func (UnimplementedPingServiceHandler) Fail(context.Context, *connect.Request[v1.FailRequest]) (*connect.Response[v1.FailResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("k6.connectrpc.ping.v1.PingService.Fail is not implemented"))
}
...
func (UnimplementedPingServiceHandler) Sum(context.Context, *connect.ClientStream[v1.SumRequest]) (*connect.Response[v1.SumResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("k6.connectrpc.ping.v1.PingService.Sum is not implemented"))
}
...
func (UnimplementedPingServiceHandler) CountUp(context.Context, *connect.Request[v1.CountUpRequest], *connect.ServerStream[v1.CountUpResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("k6.connectrpc.ping.v1.PingService.CountUp is not implemented"))
}

func (UnimplementedPingServiceHandler) CumSum(context.Context, *connect.BidiStream[v1.CumSumRequest, v1.CumSumResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("k6.connectrpc.ping.v1.PingService.CumSum is not implemented"))
}
